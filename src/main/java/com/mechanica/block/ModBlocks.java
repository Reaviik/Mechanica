...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MECHANIC_MINER = registerBlock("mechanic_miner",
            () -> new MechanicMiner(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()
                    .strength(10f).lightLevel(LUZ -> {return 1;})), ModCreativeModeTab.Mechanica_TAB);
